...
//        boolean b = false;
//
//        p = Pattern.compile("^([京,津,渝,沪,冀,晋,辽,吉,黑,苏,浙,皖,闽,赣,鲁,豫,鄂,湘,粤,琼,川,贵,云,陕,秦,甘,陇,青,台,蒙,桂,宁,新,藏,澳,军,海,航,警,使,领,A-Z]{1}(([A-Z]{1}[0-9,A-Z]{5})|([A-Z]{1}(([0-9]{5}[D,F]{1})|([D,F]{1}([A-H,J-N,P-Z,0-9]){1}[0-9]{4})))))$");
//        m = p.matcher(str);
//        b = m.matches();
//        return b;
//    }
    ...
    public static boolean isCar(String str) {
        ...
        p = Pattern.compile("^([京,津,渝,沪,冀,晋,辽,吉,黑,苏,浙,皖,闽,赣,鲁,豫,鄂,湘,粤,琼,川,贵,云,陕,秦,甘,陇,青,台,蒙,桂,宁,新,藏,澳,军,海,航,警,使,领,A-Z]{1}(([A-Z]{1}[A-H,J-N,P-Z,0-9]{4}[A-H,J-N,P-Z,0-9,挂,学,警,港,澳]{1})|([A-Z]{1}(([0-9]{5}[D,F]{1})|([D,F]{1}([A-H,J-N,P-Z,0-9]){1}[0-9]{4})))))$");
        m = p.matcher(str);
        b = m.matches();
        return b;
    }
