...
public class ConnectWifiDialog extends Dialog implements View.OnClickListener {
    ...
    private int mVisi;
    public ConnectWifiDialog(Context context, String desc, String ok, String cancel,int visi) {
    ...
    public ConnectWifiDialog(Context context, int themeResId) {
        super(context, themeResId);
        mContext = context;
    }

    protected ConnectWifiDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_connect_fragment);
        findViewById();
    }
